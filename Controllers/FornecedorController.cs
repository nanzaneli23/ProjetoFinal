...
namespace ProjetoFinal.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FornecedorNome,EmailFornecedor,CnpjFornecedor")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FornecedorNome,EmailFornecedor,CnpjFornecedor")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
